...
| 5 | Checkout + confirmation + WhatsApp | ✅ done — multi-line cart checkout, confirmation, WhatsApp, delivery fields (§15: pickup/delivery toggle, address + recipient + notes, configurable per-booking delivery fee) |
